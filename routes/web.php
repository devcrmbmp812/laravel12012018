...
Route::get('teachers/list/{school}', [
    'as' => 'user.teachers',
    'uses' => 'UsersController@teachers'
]);

Route::get('classrooms/list/{teacher}', [
    'as' => 'user.classrooms',
    'uses' => 'UsersController@classrooms'
]);

Route::get('classrooms/byschool/{school}', [
    'as' => 'user.schoolclassrooms',
    'uses' => 'UsersController@schoolclassrooms'
]);

Route::get('classrooms/parents/{school}', [
    'as' => 'user.parentclassrooms',
    'uses' => 'UsersController@parentclassrooms'
]);
...
Route::group(['middleware' => 'auth'], function () {
     ...
     */
     ...
     Route::get('storage/{foldername}/{filename}', [
   		'as' => 'file.download',
   		'uses' => 'MediaController@getFile'
 	  ]);
    Route::get('/', [
        'as' => 'dashboard',
    ...
    Route::get('parents', [
        'as' => 'user.parentlist',
        'uses' => 'UsersController@indexparents',
	'middleware' => ['permission:parents.manage']
    ]);

    Route::get('admins', [
        'as' => 'user.adminlist',
        'uses' => 'UsersController@indexadmins',
        'middleware' => ['permission:users.manage']
    ]);

    Route::get('boardmembers', [
        'as' => 'user.boardmemberslist',
        'uses' => 'UsersController@indexboardmembers',
        'middleware' => ['permission:users.manage']
    ]);

    Route::get('fiscal', [
        'as' => 'user.fiscallist',
        'uses' => 'UsersController@indexfiscal',
        'middleware' => ['permission:users.manage']
    ]);

    Route::get('employees', [
        'as' => 'user.employeelist',
        'uses' => 'UsersController@indexemployee',
        'middleware' => ['permission:users.manage']
    ]);

    Route::get('teachers', [
        'as' => 'user.teacherslist',
        'uses' => 'UsersController@indexteachers',
        'middleware' => ['permission:users.manage']
    ]);
    ...
    Route::get('parent/create', [
        'as' => 'user.createparent',
        'uses' => 'UsersController@createparent'
    ]);

    Route::post('parent/create', [
        'as' => 'user.storeparent',
        'uses' => 'UsersController@storeparent'
    ]);
    ...
    Route::get('parent/{user}/show', [
        'as' => 'user.showparent',
        'uses' => 'UsersController@viewparent'
    ]);
    ...
    Route::put('user/{user}/update/parent-details', [
        'as' => 'user.update.parent-details',
        'uses' => 'UsersController@updateParentDetails'
    ]);

    Route::put('user/{user}/update/teacher-details', [
        'as' => 'user.update.teacher-details',
        'uses' => 'UsersController@updateTeacherDetails'
    ]);
