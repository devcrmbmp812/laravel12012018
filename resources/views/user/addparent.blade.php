...
@section('page-heading', trans('app.create_new_parent'))
    ...
    <div class="card">
        <div class="card-body">
            <div class="row">
                ...
                <div class="col-md-9">
                    @include('user.partials.detailsparents', ['edit' => false, 'profile' => false])
                </div>
            </div>
        </div>
    </div>

    <div class="card" id="school_card" style="display: block;">
        <div class="card-body">
            <div class="row">
                <div class="col-md-3">
                    <h5 class="card-title">
    ...
    <label>Assigned Location</label>
        <select name="school_id" id="school_id" class="form-control input-sm">
            ...
            @endforeach
                    ...
                    <div id="parent_card" style="display: block;">
