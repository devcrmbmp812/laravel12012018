        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="tab-content mt-4" id="nav-tabContent">
                    ...
                    @if($user->role_id == "5")
                          <div class="tab-pane fade px-2" id="parent-details" role="tabpanel" aria-labelledby="nav-profile-tab">
                              {!! Form::open(['route' => ['user.update.parent-details', $user->id], 'method' => 'PUT', 'id' => 'parent-details-form']) !!}
                                  @include('user.partials.parent-details')
                              {!! Form::close() !!}
                          </div>
      		          @endif

      		          @if ($user->role_id == "3")
                          <div class="tab-pane fade px-2" id="teacher-details" role="tabpanel" aria-labelledby="nav-profile-tab">
                              {!! Form::open(['route' => ['user.update.teacher-details', $user->id], 'method' => 'PUT', 'id' => 'teacher-details-form']) !!}
                                  @include('user.partials.teacher-details')
                              {!! Form::close() !!}
                          </div>
      		          @endif
