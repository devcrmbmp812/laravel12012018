...
@section('page-heading', trans('app.parents'))
    ...
    <div class="card-body">
        ...
        <form action="" method="GET" id="users-form" class="pb-2 mb-3 border-bottom-light">
            <div class="row my-3 flex-md-row flex-column-reverse">
                ...
                <div class="col-md-2 mt-2 mt-md-0">
                    {!! Form::select('role', $roles, Input::get('role'), ['id' => 'role', 'class' => 'form-control input-solid']) !!}
                </div>

                <div class="col-md-4">
                    <a href="{{ route('user.createparent') }}" class="btn btn-primary btn-rounded float-right">
                ...
                <tbody>
                    @if (count($users))
                        @foreach ($users as $user)
                            @include('user.partials.rowparent')
                        @endforeach
                    @else
                        <tr>
